...
const tableArr = [
  ...
  },
  {
    ...
    description:
      "Style and speed. Stand out on HD ido calls backed by Studio Mics. Captureidas on the vibrant touchscreen.",
    price: 1499,
  ...
  },
  {
    ...
    description:
      "L'Or̩al Paris introduces Hyaluron Expert Replumping Serum formulated with 1.5% Hyaluronic Aid",
    price: 19,
  ...
  },
  {
    ...
    description:
      "Dermive Oil Free Moisturizer with SPF 20 is specifically formulated with ceraids, hyaluronic aid& sunscreen.",
    price: 40,
  ...
  },
  {
    ...
    description:
      "Product name: rorec collagen hyaluronic aidwhite face serum riceNet weight: 15 m",
    price: 46,
  ...
  },
  {
    ...
    description:
      "Fair & Clear is Pakistan's only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are no id effects.",
    price: 70,
...
const Search = () => {
  ...
  const Searchdata = () => {
    var hello = document.getElementById("searchtext")?.value.toLowerCase();
    if (hello === "") {
      alert("write some text");
      return false;
    }
    const result = tableArr?.filter((word) => word.title.toLowerCase() === hello);
    setvalue(result);
  };
  return (
    <>
          ...
          {value!==undefined ? (
            value.map((item, i) => (
              <tr key={i}>
                ...
                <td>{item.category}</td>
                <td>
                  <img src={item.thumbnail} alt="huhkj" />
                </td>
              </tr>
            ))
          ) : (
            tableArr.map((item, i) => (
              <tr key={i}>
                ...
                <td>{item.category}</td>
                <td>
                  <img src={item.thumbnail} alt="skl" />
                </td>
              </tr>
            ))
          )}
